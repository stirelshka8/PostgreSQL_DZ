...
-- Model Author: Shkatov Evgeny Alexandrovich, PD-62 group
...
CREATE TABLE public."Collection_track_list" (
	collection_track_list_id int4 NOT NULL,
	"Track" text,
	"Year_issue" int4,
	"track_list_id_Track_list" int4,
...
CREATE TABLE public.albums (
	...
	"Year" int4,
	"track_id_Track" int4,
	artist_album_id_artist_album int4,
...
CREATE TABLE public."Artist" (
	...
	"Name" text,
	artist_album_id_artist_album int4,
	"artist_genre_id_Artist_genre" int4,
